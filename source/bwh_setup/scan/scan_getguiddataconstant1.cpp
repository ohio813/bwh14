#include "scan_getguiddataconstant1.h"
#include "scan_common.h"
#include <commctrl.h>

#define SCAN_CATEGORY "BWH"
#define SCAN_NAME     "GetGuidDataConstant1"
#define SCAN_REQUIRED FALSE

VOID scanGetGuidDataConstant1_ScanProc(INT iItem, HWND hwndDlg, PBYTE pbFile)
{
								...
								for(DWORD dwCodeIndex2 = dwCodeIndex - 2; dwCodeIndex - dwCodeIndex2 < 20; dwCodeIndex2--)
								{
									if(*((PWORD)&pbCode[dwCodeIndex2]) == 0x5052 && pbCode[dwCodeIndex2 - 5] == 0xE8)
									{
										...
										for(DWORD dwCodeIndex3 = dwCodeIndex2 - 5; dwCodeIndex2 - dwCodeIndex3 < 20; dwCodeIndex3--)
										{
											...
											{
												// pull constant out of 'mov ecx, constant' instruction
...
VOID scanGetGuidDataConstant1_Init(HWND hwndList)
{
	...
	ppd->dwValue = 0;
	ppd->pfnScanProc = scanGetGuidDataConstant1_ScanProc;
