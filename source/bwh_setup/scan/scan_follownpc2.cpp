#include "scan_follownpc2.h"
#include "scan_common.h"
#include <commctrl.h>

#define SCAN_CATEGORY "BWH"
#define SCAN_NAME     "FollowNpc2"
#define SCAN_REQUIRED FALSE

VOID scanFollowNpc2_ScanProc(INT iItem, HWND hwndDlg, PBYTE pbFile)
{
...
VOID scanFollowNpc2_Init(HWND hwndList)
{
	...
	ppd->dwValue = 0;
	ppd->pfnScanProc = scanFollowNpc2_ScanProc;
